  ...
  <div class="list row">
    ...
    <div class="col-md-6">
      <div v-if="currentCourse">
        ...
        <div>
          <label><strong>Status:</strong></label> {{ currentCourse.animated ? "Animated" : "Suspended" }}
        </div>

   <!-- <router-link :to="'/courses/' + currentCourse.id" class="badge badge-warning">Edit</router-link> -->
        <router-link :to="'/courses/' + currentCourse.id">
            <button class="badge badge-warning mr-2">Edit</button>
        </router-link>
